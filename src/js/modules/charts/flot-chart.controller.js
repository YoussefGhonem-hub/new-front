...
(function() {
    ...
    function FlotChartController($scope, $http, $timeout, flotOptions, colors) {
      ...
      vm.chartLineFlotChart       = angular.extend({}, flotOptions['line'], { yaxis: { max: 60 }});

      // Set directly our global configuration
      vm.chartBarFlotChart        = flotOptions['bar'];
      vm.chartBarStackedFlotChart = flotOptions['bar-stacked'];
