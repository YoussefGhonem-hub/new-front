...
(function () {
    ...
    angular
        .module('eServices')
        .controller('MediaLicenseController', MediaLicenseController);

    function MediaLicenseController($rootScope, $scope, $http, $stateParams, $state, $window, $uibModal, UserProfile, browser, DTOptionsBuilder, DTColumnBuilder, $compile, $filter) {
        var vm = this;
    ...
    MediaLicenseController.$inject = ['$rootScope', '$scope', '$http', '$stateParams', '$state', '$window', '$uibModal', 'UserProfile', 'browser', 'DTOptionsBuilder', 'DTColumnBuilder',
        '$compile', '$filter'];
})();