...
(function () {
    ...
    angular
        .module('eServices')
        .controller('AerialPhotographyPermitController', AerialPhotographyPermitController);

    function AerialPhotographyPermitController($rootScope, $scope, $http, $stateParams, $state, UserProfile, $uibModal, $filter, DTOptionsBuilder, DTColumnBuilder, $compile, SweetAlert, browser) {
        var vm = this;
        vm.user = UserProfile.getProfile();
        vm.serviceFeesObj = { serviceId: 14, serviceFee: [], isExpo2020: false, establishmentId: 0 };
        ...
        vm.Init = function () {
            ...
            vm.happinessMeterObj.serviceId = 14;
            ...
            $http.get($rootScope.app.httpSource + 'api/PhotographyType')
                .then(function (response) {
                    ...
                    if ($state.params === undefined || $state.params.id === undefined || $state.params.id === "") {
                        var aerialPhotographyType = {};
                        aerialPhotographyType.photographyType = vm.photographyTypes[1];
                        vm.photographyPermitModel.photographyPermitTypes.push(aerialPhotographyType);
                    }
                },
            ...
            vm.locationDt.open = function (size) {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: 'app/views/Application/AerialPhotographyPermit/filmingLocation/filmingLocation.html',
                    controller: 'AerialFilmingLocationController',
                    size: size,
                    resolve: {
                        location: function () {
                            return null;
            ...
            vm.locationDt.edit = function (size, addressId) {
                var modalInstance = $uibModal.open({
                    ...
                    resolve: {
                        location: function () {
                            return $filter('filter')(vm.photographyPermitModel.photographyPermitLocations, { id: addressId }, true)[0];
                        }
                    }
                });
            ...
            vm.teamMemberDt.open = function (size) {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: 'app/views/Application/AerialPhotographyPermit/filmingTeam/filmingTeam.html',
    ...
    AerialPhotographyPermitController.$inject = ['$rootScope', '$scope', '$http', '$stateParams', '$state', 'UserProfile', '$uibModal', '$filter', 'DTOptionsBuilder', 'DTColumnBuilder', '$compile', 'SweetAlert', 'browser'];
