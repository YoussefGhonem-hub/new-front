...
(function () {
    ...
    approvalController.$inject = ['$rootScope', '$scope', 'UserProfile', '$filter', 'DTOptionsBuilder', 'DTColumnBuilder', '$compile', '$http', '$uibModal', '$state', 'SweetAlert'];
    function approvalController($rootScope, $scope, UserProfile, $filter, DTOptionsBuilder, DTColumnBuilder, $compile, $http, $uibModal, $state, SweetAlert) {
        var vm = this;
        ...
        function serverData(sSource, aoData, fnCallback, oSettings) {
            ...
            $http.post($rootScope.app.httpSource + 'api/Application/GetPendingDataApprovalApplications', params)
                .then(function (resp) {
